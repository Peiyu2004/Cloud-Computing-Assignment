...
<body>
    ...
    <section id="about-head" class="section-p1">
        <img src="<?php echo $s3_base; ?>img/about/x2.jpg" alt="" />
        <div>
            <h2>About Us?</h2>
            <p class="paragraph">
    ...
    <section id="feature" class="section-p1">
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f1.png" alt="" />
            <h6>Free Shipping</h6>
        </div>
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f2.png" alt="" />
            <h6>Online Order</h6>
        </div>
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f3.png" alt="" />
            <h6>Save Money</h6>
        </div>
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f4.png" alt="" />
            <h6>Promotions</h6>
        </div>
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f5.png" alt="" />
            <h6>Happy Sell</h6>
        </div>
        <div class="fe-box">
            <img src="<?php echo $s3_base; ?>img/features/f6.png" alt="" />
            <h6>24/7 Support</h6>
        </div>
    </section>
